...
REPO="madhu-gowda6/GlobalProtect-openconnect"
...
perl -0pi -e '
s|(url = "https://github\.com/madhu-gowda6/GlobalProtect-openconnect/releases/download/v\$\{version\}/globalprotect-openconnect-\$\{version\}\.tar\.gz";\n\s*hash = ")[^"]+(";})|$1 . $ENV{"SOURCE_HASH"} . $2|e;
