  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        src = pkgs.fetchzip {
          url = "https://github.com/madhu-gowda6/GlobalProtect-openconnect/releases/download/v${version}/globalprotect-openconnect-${version}.tar.gz";
        ...
        gpgui = pkgs.fetchzip {
          url = "https://github.com/madhu-gowda6/GlobalProtect-openconnect/releases/download/v${version}/gpgui_${cpu}.bin.tar.xz";
          hash = {
      ...
      in
      {
        ...
        packages.default = naersk'.buildPackage {
          ...
          postInstall = ''
            ...
            substituteInPlace $out/share/polkit-1/actions/com.atharv.gpgui.policy \
              --replace-fail /usr/bin/gpservice $out/bin/gpservice
