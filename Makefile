...
install:
	...
	install -Dm644 packaging/files/usr/share/applications/gpgui.desktop $(DESTDIR)/usr/share/applications/com.atharv.gpgui.desktop
...
uninstall:
	...
	rm -f $(DESTDIR)/usr/share/applications/com.atharv.gpgui.desktop
